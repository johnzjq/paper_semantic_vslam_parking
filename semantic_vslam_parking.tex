...
Fiducial markers are introduced as an aid for the constancy of localization since few parking lot is detected near the entrances and exits (John:but we put the markers in the inner path of two rings?). 
...
Due to fallible detection of parking spaces and their ids with low-quality surround vising images, ambiguities will be presented during date association.
We thus proposed robust outlier detection and elimination method during this stage.
