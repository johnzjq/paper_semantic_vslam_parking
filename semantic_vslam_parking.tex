...
To prevent integrating all the features (should use the expression from PTAM), PTAM\cite{Klein2007Parallel} separates tracking and mapping into two tasks, but still works in small areas(a desk or a room corner). 
